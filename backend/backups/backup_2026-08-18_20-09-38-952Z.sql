...
-- Generated: 2026-08-18T20:09:38.952Z
...
INSERT INTO users (user_id, name, email, password_hash, created_at, updated_at) VALUES ('10', 'Audit User Updated', 'audit_1787083778538@finance.com', '$2b$10$.Zu/5NE5wPxy/jZJqeyq/uW0MD4/aC/vOWO3QJjWXA4zsfN53RoV2', '2026-08-18 20:09:38', '2026-08-18 20:09:38');
...
INSERT INTO categories (category_id, user_id, category_name, category_type) VALUES ('20', '10', 'TestCat_1787083778788', 'Expense');
...
INSERT INTO transactions (transaction_id, user_id, category_id, amount, type, description, transaction_date, created_at, updated_at) VALUES ('24', '4', '1', '500', 'Expense', 'I spent 500 on food', '2026-08-18', '2026-08-18 20:09:19', '2026-08-18 20:09:19');
INSERT INTO transactions (transaction_id, user_id, category_id, amount, type, description, transaction_date, created_at, updated_at) VALUES ('25', '10', '9', '4500', 'Income', 'Monthly Salary Audit', '2026-08-16', '2026-08-18 20:09:38', '2026-08-18 20:09:38');
INSERT INTO transactions (transaction_id, user_id, category_id, amount, type, description, transaction_date, created_at, updated_at) VALUES ('26', '10', '1', '350', 'Expense', 'Groceries Audit', '2026-08-16', '2026-08-18 20:09:38', '2026-08-18 20:09:38');
INSERT INTO transactions (transaction_id, user_id, category_id, amount, type, description, transaction_date, created_at, updated_at) VALUES ('27', '10', '1', '80', 'Expense', 'Spent 80 dollars on groceries yesterday', '2026-08-17', '2026-08-18 20:09:38', '2026-08-18 20:09:38');
...
INSERT INTO budgets (budget_id, user_id, month, year, budget_limit) VALUES ('7', '10', '8', '2026', '2000');
...
INSERT INTO ai_insights (insight_id, user_id, message, insight_type, created_at) VALUES ('19', '4', '{"type":"Recommendation","category":"Recommendation","title":"Financial Health Stable","message":"Your transactions are balanced. Continue tracking regular expenses to receive deeper AI recommendations.","impact":"Neutral","icon":"fa-chart-line"}', 'Recommendation', '2026-08-18 20:09:19');
INSERT INTO ai_insights (insight_id, user_id, message, insight_type, created_at) VALUES ('21', '10', '{"type":"Achievement","category":"Achievement","title":"Budget Discipline on Track","message":"You have used only 0% of your monthly budget with 12 days left. Great financial discipline!","impact":"Positive","icon":"fa-circle-check"}', 'Achievement', '2026-08-18 20:09:38');
...
INSERT INTO voice_entries (voice_id, user_id, voice_text, parsed_amount, parsed_type, parsed_category, created_at) VALUES ('18', '4', 'What is my remaining budget?', '0', 'Query Budget', 'Budget', '2026-08-18 20:09:19');
INSERT INTO voice_entries (voice_id, user_id, voice_text, parsed_amount, parsed_type, parsed_category, created_at) VALUES ('19', '4', 'How much did I spend on food?', '0', 'Category Query', 'Food', '2026-08-18 20:09:19');
INSERT INTO voice_entries (voice_id, user_id, voice_text, parsed_amount, parsed_type, parsed_category, created_at) VALUES ('20', '4', 'I spent 500 on food', '500', 'Expense', 'Food', '2026-08-18 20:09:19');
INSERT INTO voice_entries (voice_id, user_id, voice_text, parsed_amount, parsed_type, parsed_category, created_at) VALUES ('21', '10', 'Spent 80 dollars on groceries yesterday', '80', 'Expense', 'Food', '2026-08-18 20:09:38');
